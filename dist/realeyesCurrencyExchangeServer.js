...
var baseAssign = __webpack_require__(142),
...
(function() {
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent) {
      ...
      if (XMLElement === null) {
        XMLElement = __webpack_require__(87);
        XMLCData = __webpack_require__(83);
        XMLComment = __webpack_require__(84);
        XMLDeclaration = __webpack_require__(85);
        XMLDocType = __webpack_require__(86);
        XMLRaw = __webpack_require__(250);
        XMLText = __webpack_require__(252);
      }
    }
...
var codes = __webpack_require__(238)
...
exports.default = {
    ...
    root: '/',
    latest: '/latest',
    exchangeServerHistoryEndpoint: 'http://www.ecb.europa.eu/stats/eurofxref/eurofxref-hist-90d.xml'
};
...
var relative = __webpack_require__(23).relative
...
lazyProperty(module.exports, 'bufferConcat', function bufferConcat() {
  return Buffer.concat || __webpack_require__(117)
})
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString() {
  ...
  return stack[0].toString ? toString : __webpack_require__(118)
})
...
var url = __webpack_require__(25);
var assert = __webpack_require__(254);
...
var pathRegexp = __webpack_require__(226)
var debug = __webpack_require__(42)('router:layer')
...
(function() {
  ...
  XMLDTDAttList = __webpack_require__(246);

  XMLDTDEntity = __webpack_require__(248);

  XMLDTDElement = __webpack_require__(247);

  XMLDTDNotation = __webpack_require__(249);

  XMLProcessingInstruction = __webpack_require__(88);
...
(function() {
  ...
  XMLAttribute = __webpack_require__(244);
...
var Server = function () {
    function Server(config, router) {
        _classCallCheck(this, Server);

        this.server = _http2.default.createServer(function (req, res) {
    ...
    _createClass(Server, [{
        key: 'start',
        value: function start(startCb, errorCb) {
            var _this = this;

            this.server.listen(this.config.port, this.config.hostname, function () {
                console.info('currencyExchangeRealeyes Server listening at port:' + _this.config.port);
            });
        }
    }]);
...
var _finalhandler = __webpack_require__(123);

var _finalhandler2 = _interopRequireDefault(_finalhandler);

var _serveStatic = __webpack_require__(237);
...
var _handlers = __webpack_require__(114);
...
var CERouter = function () {
    function CERouter() {
        _classCallCheck(this, CERouter);

        this.router = (0, _router2.default)();
        this.static = (0, _serveStatic2.default)('dist', {
            index: ['index.html']
        });
        this.setup(this.router);
    }

    _createClass(CERouter, [{
        key: 'setup',
        value: function setup(router) {
            router.use(this.static);
            router.get(_constants2.default.history, handlers.exchangeHistory);
        }
    }, {
        key: 'serve',
...
var http = __webpack_require__(22);
var https = __webpack_require__(90);
var httpFollow = __webpack_require__(58).http;
var httpsFollow = __webpack_require__(58).https;
var url = __webpack_require__(25);
...
module.exports = {
	"_args": [
		[
			...
			"/Users/koushik/Workspace/js/currencyExchangeRealeyes"
		]
	],
	...
	"_shrinkwrap": null,
	"_spec": "axios@^0.15.3",
	"_where": "/Users/koushik/Workspace/js/currencyExchangeRealeyes",
	"author": {
		"name": "Matt Zabriskie"
	},
	"browser": {
...
var server = new _init2.default(config, new _router2.default());
...
function ExchangeEndpoint(onSuccess, onFailure) {
    ...
    axiosWithTimeout.get(_constants2.default.exchangeServerHistoryEndpoint, {
        headers: {
...
var _xml2js = __webpack_require__(243);

var _exchange = __webpack_require__(112);
...
function exchangeHistory(req, res) {
    (0, _exchange.ExchangeEndpoint)(function (data) {
...
exports.exchangeHistory = undefined;

var _exchangeHistory = __webpack_require__(113);

var _exchangeHistory2 = _interopRequireDefault(_exchangeHistory);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.exchangeHistory = _exchangeHistory2.default;
...
var unpipe = __webpack_require__(239)
...
var deprecate = __webpack_require__(56)('http-errors')
...
var arrayEvery = __webpack_require__(136),
    baseEvery = __webpack_require__(145),
...
mime.define(__webpack_require__(225));
...
var debug = __webpack_require__(42)('router')
var flatten = __webpack_require__(78)
var Layer = __webpack_require__(77)
var methods = __webpack_require__(75)
...
var debug = __webpack_require__(42)('router:route')
var flatten = __webpack_require__(78)
var Layer = __webpack_require__(77)
var methods = __webpack_require__(75)
...
;(function (sax) { // wrapper for non-node envs
  ...
  SAXStream.prototype.write = function (data) {
    if (typeof Buffer === 'function' &&
      ...
      if (!this._decoder) {
        var SD = __webpack_require__(256).StringDecoder
...
var debug = __webpack_require__(235)('send')
...
var onFinished = __webpack_require__(76)
var parseRange = __webpack_require__(227)
var path = __webpack_require__(23)
var statuses = __webpack_require__(43)
var Stream = __webpack_require__(24)
var util = __webpack_require__(12)
...
var send = __webpack_require__(233)
var url = __webpack_require__(25)
...
(function() {
  ...
  sax = __webpack_require__(232);

  events = __webpack_require__(44);

  builder = __webpack_require__(253);

  bom = __webpack_require__(241);

  processors = __webpack_require__(242);

  setImmediate = __webpack_require__(257).setImmediate;
...
(function() {
  ...
  XMLStringifier = __webpack_require__(251);
...
(function() {
  ...
  XMLBuilder = __webpack_require__(245);
